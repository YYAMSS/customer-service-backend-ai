...
def _resolve_prompt_path(prompt_name: str) -> Path:
    ...
    relative_path = candidate if candidate.suffix else candidate.with_suffix(_DEFAULT_SUFFIX)
...
def load_prompt_template(prompt_name: str, template_format: str = "jinja2") -> PromptTemplate:
